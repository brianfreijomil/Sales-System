...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C9A6F962E");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F6BDD091A");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483AC8B0940");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107011C3EFB");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547EAE04EFF5");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A1323A93D4E8");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F760D8B9350");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D84CA3C909");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEE28CECFF5");
        ...
        {
            entity.HasOne(u => u.IdRolNavigation)
            .WithMany()
            .HasForeignKey(u => u.IdRol)
            .HasPrincipalKey(r => r.IdRol);

            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A6957D785B");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D561427761DDC");
