...
$("#btnBuscar").click(function () {
    ...
    fetch(`/Venta/Historial?numberSale=${numeroVenta}&dateInit=${fechaInicio}&dateEnd=${fechaFin}`)
        .then(response => {
...
$("#tbventa tbody").on("click", ".btn-info", function () {
    ...
    $("#linkImprimir").attr("href",`/Venta/MostrarPDFVenta?numberSale=${d.numeroVenta}`)
